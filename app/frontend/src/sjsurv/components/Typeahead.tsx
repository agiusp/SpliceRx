...
// Identical to sjvc's Typeahead.tsx (fully generic, no sjvc coupling) — kept
// as a small per-app copy rather than a cross-app import, matching this
// codebase's convention that each app owns its own component tree.
