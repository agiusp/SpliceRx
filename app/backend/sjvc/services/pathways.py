...
# label shown in the UI -> library name (== Enrichr library name for the
# downloadable ones; "xCell" / "ConsensusTME" have no Enrichr equivalent and
# only ever exist as the bundled GMT - see scripts/export_pathway_gmt.R)
LIBRARIES: Dict[str, str] = {
    ...
    "xCell (cell types)": "xCell",
    "ConsensusTME (tumour microenvironment)": "ConsensusTME",
}
